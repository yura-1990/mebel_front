...
function KitchenMebels({kitchenMebels,kitchenMebelsByID, curLang}) {
  return (
    <div>
    ...
    <div className="container-fluid">
      <div className="row category-top mebel-list justify-content-center">
        <div className="col-12">
          {kitchenMebels && <div className="card shadow">
            ...
            kitchenMebels?.map((el, i)=>{
              return (
                <div key={i} className="mt-4 col-xl-3 col-lg-4 col-sm-6 co-12">
                  <Link to={`/mebel/kitchenmebel/${el.id}`} onClick={()=>kitchenMebelsByID(el.id)} className='bg-white text-custom rounded-3 d-flex h-100 p-3 overflow-hidden shadow'>
